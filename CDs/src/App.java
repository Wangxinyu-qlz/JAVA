...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s = new String("test");//s是字符串的管理者
        String s1 = "test1";
        System.out.println(s + "112");//test112
        System.out.println(s + 12 + 12);//test1212
        System.out.println(s + (12+12));//test24

        String s2;
        Scanner srx = new Scanner(System.in);
        //输入：hello world
        s2 = srx.nextLine();//回车结束
        System.out.println(s2);//hello world
        String s3 = srx.next();//空格结束
        System.out.println(s3);//hello
        // 字符串内容的判断
        System.out.println(s3 == "hello");//false  比较变量
        System.out.println(s3.equals("hello"));//True  比较内容

        String s4 = "1234563";
        int loc = s4.indexOf('3');
        System.out.println(s4.indexOf('3', loc+1));//6

        // 不修改s5本身，而是创建新变量，并输出新变量结果
        String s5 = "qwe";
        System.out.println(s5.toUpperCase());//QWE
        System.out.println(s5);//qwe
        
        Scanner inn = new Scanner(System.in);
        int nn = inn.nextInt();
        System.out.println(isN(nn));
        
        int qq = 1;
        int pp = 0;
        swap(qq, pp);
        System.out.println("qq=" + qq + " pp=" + pp);//qq=1 pp=0
    }
}
